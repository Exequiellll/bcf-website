                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700">
                            <strong>Add Team Members</strong> to showcase your church leadership, worship team, pastors, and other key members. Upload photos, add contact information, and feature important members on the homepage. Members are organized by roles: Pastors, Singers, Band Members, and Leaders.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <ul class="divide-y divide-gray-200">
                ...
                @empty
                    <li class="px-4 py-4 sm:px-6">
                        <p class="text-gray-500">No people added yet.</p>
                    </li>
                @endforelse
            </ul>
        </div>
